        ...
        <div class="grid grid-cols-2">
          ...
          <div class="flex flex-col items-center w-full h-[528px] py-12 px-20 relative">
              ...
              <div class="flex justify-center">
                ...
                <label class="form-control w-full max-w-xs mb-6">
                  ...
                  <label class="input input-bordered w-60 h-9 flex items-center gap-2 shadow-md focus:shadow-md rounded text-xs">
                    ...
                    <input type="date" class="grow" placeholder="Date of Birth" />
                  </label>
                </label>
                ...
                <div class="flex justify-center">
                  ...
                  <label class="form-control w-full max-w-xs">
                    ...
                    <label id="input_password" class="input input-bordered w-60 h-9 flex items-center gap-2 shadow-md focus:shadow-md rounded text-xs">
                      ...
                      <input type="password" id="password" class="grow" value="" placeholder="Password" />
                    </label>
                  </label>
            ...
            <p class="text-xs">
              ...
              <a href="#" class="text-blue-800 hover:underline">Log In</a>
            </p>
          </div>
        </form>
          <!-- form input -->
