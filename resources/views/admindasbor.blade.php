    ...
    <div class="drawer lg:drawer-open">
              ...
              <div class="grid grid-cols-5 gap-4 mt-10">
                ...
                <div class="stats shadow-lg shadow-neutral-300 w-full">
                  <div class="stat">
                    ...
                    <div class="stat-value font-black">10</div>
                  </div>
                </div>
                <!-- card 3 -->
                <div class="stats shadow-lg shadow-neutral-300 w-full">
        ...
        <div class="drawer-side">
          ...
          <ul class="bg-[#0C3FF3] menu p-4 w-64 min-h-full text-white">
            ...
            <li class="bg-white rounded-full text-black"><a><svg class="h-6 w-6" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              Dashboard</a></li>
            <li class="#"><a class=""><svg class="h-6 w-6" fill="none" viewBox="0 0 35 35" xmlns="http://www.w3.org/2000/svg">
