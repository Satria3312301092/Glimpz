    ...
    <div class="drawer lg:drawer-open">
                ...
                <table class="table bg-white mb-24 text-slate-700">
                  ...
                  <tbody>
                    ...
                    <tr>
                        ...
                        <td>Rp.99.000</td>
                        <td><div class="badge badge-outline text-xs text-orange-500">Payment Pending</div></td>
                        <th>
                            <div class="dropdown">
                              <div tabindex="0" role="button" class="btn btn-square btn-ghost bg-base-100">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" class="inline-block w-5 h-5 stroke-current"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 12h.01M12 12h.01M19 12h.01M6 12a1 1 0 11-2 0 1 1 0 012 0zm7 0a1 1 0 11-2 0 1 1 0 012 0zm7 0a1 1 0 11-2 0 1 1 0 012 0z"></path></svg>
        ...
        <div class="drawer-side">
          ...
          <ul class="bg-[#0C3FF3] menu p-4 w-64 min-h-full text-white">
            ...
            <li><a><svg class="h-6 w-6" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              Dashboard</a></li>
            <li><a><svg class="h-6 w-6 text-white" fill="none" viewBox="0 0 35 35" xmlns="http://www.w3.org/2000/svg">
              ...
              Users</a></li>
            <li><a><svg class="h-6 w-6 text-white" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              Service</a></li>
            <li><a><svg class="h-6 w-6 text-white" viewBox="0 0 33 33" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M16.4657 4.11283C15.4825 4.12383 14.531 4.32184 13.8009 4.67109C12.5365 5.27746 5.5083 8.79609 5.5083 8.79609C7.88347 9.98409 14.0883 13.0861 14.8748 13.4794C15.7314 13.907 17.2852 13.9084 18.1418 13.4794L27.5935 8.84007C27.5935 8.84007 21.2768 5.63634 19.3009 4.67109C18.4649 4.26271 17.4474 4.10183 16.4657 4.11283ZM4.1333 10.9878V20.5276C4.13344 22.1899 5.26011 23.9953 6.75432 24.7378L15.1333 28.8628V16.3586C14.7524 16.3063 14.0539 16.0974 13.6293 15.8856L4.90674 11.5461C4.39771 11.2931 4.1333 10.9878 4.1333 10.9878ZM28.8833 10.9878C28.8833 10.9878 28.6193 11.2931 28.1105 11.5461L19.3875 15.8856C18.9627 16.0974 18.2642 16.3063 17.8833 16.3586V28.8628L26.2625 24.7378C27.7558 23.9953 28.8833 22.1899 28.8833 20.5276V10.9878Z" fill="currentColor"/>
              </svg>              
              Order</a></li>
            <li><a><svg class="h-6 w-6 text-white" viewBox="0 0 33 33" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              Invoice</a></li>
            <li class="bg-white rounded-full text-black"><a><svg class="h-6 w-6" viewBox="0 0 33 33" fill="none" xmlns="http://www.w3.org/2000/svg">
