            ...
            <div class="w-full h-full">
              <div class="grid grid-cols-2 pl-12 pt-12 pr-12">
                <div>
                  ...
                  <a class="text-xs text-blue-500">10 Users Found</a>
                </div>
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="flex items-center gap-3">
                            ...
                            <div>
                              <div class="font-normal">Hyerin</div>
                            </div>
                          </div>
                        </td>
                        <td>
        ...
        <div class="drawer-side">
          ...
          <ul class="bg-[#0C3FF3] menu p-4 w-64 min-h-full text-white">
            ...
            <li><a><svg class="h-6 w-6" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              Dashboard</a></li>
            <li class="bg-white rounded-full text-black"><a class=""><svg class="h-6 w-6" fill="none" viewBox="0 0 35 35" xmlns="http://www.w3.org/2000/svg">
