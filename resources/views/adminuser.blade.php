                      ...
                      <dialog id="my_modal_7{{ $user->Id_User }}" class="modal">
                        <div class="modal-box">
                          ...
                          <form action="{{ route('adminuser.destroy', $user->Id_User) }}" method="POST">
                            @csrf
                            @method('DELETE')
                          <button type="submit"  class="focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900 mt-3">BAN</button>
                        </div>
                      </form>
                    </tbody>
                    @endif
