    ...
    justify-center ">
            ...
            shadow-lg max-w-4xl border form-container ">
                ...
                <div class="w-1/2 px-16 flex flex-col">
                    ...
                    <img class="mx-auto w-20 h-20 mb-5" src="Jamal-Image/logo.png" alt="">Sign in</h2>
                    ...
                    <span class="label-text">Password</span>
                        ...
                        <a href="{{ url('pembayaran') }}" class="bg-blue-600 min-h-16 text-white py-5 mt-5 rounded-lg block text-center text-xl">Sign in</a>
                        <div class="text-sm flex justify-center">
                        <p class="text-center">Already have account?</p>
                        <a href="{{ url('pembayaran') }}" class="text-blue-600 font-bold underline">Login</a>
                        </div>
                    </form>
                </div>
                <!-- image -->
                <div class="sm:block hidden w-1/2">
                    <img class="rounded-l-2xl border" src="Jamal-Image/login.png" alt="">
                </div>
            </div>
    </section>
</body>
