...
<head>
    ...
    .summary-border {
        border-right: 2px solid #6b728099;
    }
    .invoice-summary {
        margin: auto;
    }
            ...
            <table class="items-center mb-5">
                <tr>
                    ...
                    <td>
                        ...
                        <span class="text-sm">Invoice ID {{ $invoice->Id_Invoice }}</t</span>
                    </td>
                </tr>
            </table>
            <div class="bg-gray-200 rounded-2xl p-5 mb-8">
            <table class="w-full text-left invoice-detail">
                <tr>
                <td class="px-8 py-2 summary-border">
