...
<body class="font-poppins bg-white">
  ...
  <div class="container mx-auto pt-20">
    <h2 class="font-semibold font-['Poppins'] text-2xl mb-16 text-black">I Will Made a 2D Character Animation</h2>
    <div class="grid grid-cols-5 gap-x-14">
        <div class="col-span-3 grid gap-y-4">
            <img src="https://img.daisyui.com/images/stock/photo-1606107557195-0e29a4b5b4aa.jpg" class="rounded-2xl w-full" alt="">
            ...
            <div>
                ...
                <p class="text-neutral-500">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam.</p>
            </div>

            <div>
                <h1 class="font-bold text-slate-700 text-xl mb-2">Category</h1>
                <p class="text-neutral-500">Character Animation</p>
            </div>
        </div>
